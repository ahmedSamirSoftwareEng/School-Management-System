    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown ">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-big dropdown-notifications">
                <div class="dropdown-header notifications">
                    <strong>{{trans('main_sidebar.Notifications')}}</strong>
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="text-danger ti-unlock"></i>{{ __('main_sidebar.Logoff') }}</a>
